import MongoUserRepository from '../domains/auth/repositories/mongodb/user.repository.js';
import MongoTokenBlacklistRepository from '../domains/auth/repositories/mongodb/token_blacklist.repository.js';
import MongoSystemSettingsRepository from '../domains/shared/repositories/mongodb/systemSettings.repository.js';
import MongoAuditLogRepository from '../domains/users/repositories/mongodb/auditLog.repository.js';
import MongoProductRepository from '../domains/ecommerce/repositories/mongodb/product.repository.js';
import MongoCartItemRepository from '../domains/ecommerce/repositories/mongodb/cartItem.repository.js';
import MongoOrderRepository from '../domains/ecommerce/repositories/mongodb/order.repository.js';
import { PostgresUserRepository } from '../domains/auth/repositories/postgres/user.repository.js';
import { PostgresTokenBlacklistRepository } from '../domains/auth/repositories/postgres/token_blacklist.repository.js';
import { PostgresSystemSettingsRepository } from '../domains/shared/repositories/postgres/systemSettings.repository.js';
import { PostgresAuditLogRepository } from '../domains/users/repositories/postgres/auditLog.repository.js';
import { PostgresProductRepository } from '../domains/ecommerce/repositories/postgres/product.repository.js';
import { PostgresCartItemRepository } from '../domains/ecommerce/repositories/postgres/cartItem.repository.js';
import { PostgresOrderRepository } from '../domains/ecommerce/repositories/postgres/order.repository.js';
